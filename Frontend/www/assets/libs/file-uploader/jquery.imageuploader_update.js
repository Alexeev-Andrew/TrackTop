    ...
    $.fn.uploader = function (options, testMode) {
        return this.each(function (index) {
            options = $.extend({
                ...
                secondarySelectButtonCopy: 'Завантажити ще',
                //dropZone: $(this),
            ...
            function addItem (file) {
                ...
                var thumbnail = $('<img class="thumbnail"><i clgridass="fa fa-spinner fa-spin uploader__icon--spinner"></i>');
                var removeLink = $('<button onclick=\"preventDefault(); console.log(\'delete click\')\"class="delete uploader__icon-button js-upload-remove-button fa fa-times" data-index="' + id + '"></button>');
