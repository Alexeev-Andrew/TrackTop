...
exports.technicWithoutCategory = ejs.compile(fs.readFileSync('./Frontend/templates/technic_without_category2.ejs', "utf8"));
...
exports.oneOrder = ejs.compile(fs.readFileSync('./Frontend/templates/order.ejs', "utf8"));
exports.oneOrderModal = ejs.compile(fs.readFileSync('./Frontend/templates/order-modal.ejs', "utf8"));